...
activities = {
    ...
    "Soccer Club": {
        "description": "Join the soccer club for recreational and competitive play",
    ...
    "Music Ensemble": {
        "description": "Join our music ensemble performing various genres",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Normalize email and validate student is not already signed up (case-insensitive)
